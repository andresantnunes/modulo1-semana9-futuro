...
import com.senai.aula4.entites.EmpresaCustomizadaEntity;
...
public interface EmpresaRepository extends JpaRepository<EmpresaEntity, Long> {
    ...
    @Query("update EmpresaEntity empresa set " + //JPQL é um "SQL" genérico que irá funcionar em qualquer banco de dados
            " empresa.nome = :nome," +
            " empresa.cnpj = :cnpj, " + //:cnpj indica o uso de uma variavel que veio por paramentro, ele usa o nome no @Param
            " empresa.anoCriacao = :anoCriacao " +
            " where empresa.id = :id")
